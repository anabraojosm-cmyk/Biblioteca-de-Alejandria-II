...
export const FAMILY_REL_KEYS = ["padre", "hijo", "hermano", "familia"];
...
export const MILITARY_RANKS = ["Recluta", "Soldado", "Sargento", "Capitán", "Comandante", "General", "Gran Mariscal"];
...
export const COLOR_PRESETS = ["#7c5cbf", "#b0479a", "#3d8a7a", "#C1594A", "#4F86A8", "#8AA85F", "#C9A24B", "#7A5EA8", "#4F7BB0", "#A8683F", "#E8C547", "#D97F3D", "#F5F3EB", "#8B8B85", "#2B2A27", "#4FB8C9", "#1F3A63", "#8C1F1F"];
...
export const CORK_SIZES: Record<string, number> = { S: 110, M: 150, L: 200 };
