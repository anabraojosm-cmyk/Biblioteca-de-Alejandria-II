...
import {
  BookOpen, Users, Layers, Calendar as CalendarIcon, GitBranch, GitGraph, MapPin, Orbit,
...
const smallOutlineBtn = { borderStyle: "solid", borderWidth: 1, borderColor: "var(--border)", borderRadius: 6, padding: "6px 10px", cursor: "pointer", fontSize: 12, background: "var(--bg2)", color: "var(--text)" };
